...
public class TC_build1_002 extends BaseClass{
	@Test
	...
	public void textAndClaer() throws IOException, Throwable {
		...
		homepage.firstNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("firstText1"));
		homepage.secondNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("secondText1"));
