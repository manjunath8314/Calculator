...
public class TC_build1_004 extends BaseClass {
	@Test
	...
	public void textAndClaer() throws IOException, Throwable {
		...
		homepage.firstNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("firstText3"));
		homepage.secondNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("secondText3"));
