...
public class TC_build1_003 extends BaseClass{
	@Test
	...
	public void textAndClaer() throws IOException, Throwable {
		...
		homepage.firstNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("firstText2"));
		homepage.secondNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("secondText2"));
