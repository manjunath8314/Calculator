...
public class TC_build1_001 extends  BaseClass{
	@Test
	...
	public void textAndClaer() throws IOException, Throwable {
		...
		homepage.firstNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("firstText"));
		homepage.secondNumberTextField.sendKeys(fileUtils.readDataFromPropertyFile("secondText"));
